...
if (button !== null) {
    ...
    form = '<form><label for="phone" style="' + labelStyles + '">Phone Number</label><input style="' + inputStyles + '" type="text" placeholder="254722123456" name="phone"></input><br>' + phoneInstruction + '<br><br><button href="" id="mpesaSend" style="' + styles + ' width: 100%;">' + img + '<span style="margin-left: 15px;">Pay</span></button></form>'
